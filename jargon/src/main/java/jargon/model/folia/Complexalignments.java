 ...
 *         &lt;element ref="{http://ilk.uvt.nl/folia}complexalignment" maxOccurs="unbounded" minOccurs="0"/>
...
public class Complexalignments {
    ...
    protected List<Complexalignment> complexalignment;
    ...
    /**
     * Gets the value of the complexalignment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the complexalignment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getComplexalignment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Complexalignment> getComplexalignment() {
        if (complexalignment == null) {
            complexalignment = new ArrayList<Complexalignment>();
        }
        return this.complexalignment;
    }
