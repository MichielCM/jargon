 ...
 *         &lt;element ref="{http://ilk.uvt.nl/folia}external" maxOccurs="unbounded" minOccurs="0"/>
...
public class Speech {
    ...
    protected java.util.List<External> external;
     ...
     * 
     */
    public java.util.List<External> getExternal() {
        if (external == null) {
